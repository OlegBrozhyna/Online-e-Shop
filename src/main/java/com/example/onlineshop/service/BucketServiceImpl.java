...
import com.example.onlineshop.dao.BucketRepository;
...
import com.example.onlineshop.dto.BucketDetailDTO;
...
public class BucketServiceImpl implements BucketService {
    ...
    private List<Product> getCollectRefProductsById(List<Long> productIds) {
        return productIds.stream()
                //getOne витягує посиллання на обє'кт, findById- витягує сам обє'кт
    ...
    @Override
    public BucketDTO getBucketUser(String name) {
